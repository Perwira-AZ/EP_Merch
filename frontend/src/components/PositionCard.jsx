  ...
  return (
    <div className="position-card w-full py-3 px-5 mt-1 mb-3 bg-white rounded-[15px] shadow-2xl bg-gradient-to-bl from-cyan-300 to-blue-500" id={num}>
      <form action="" className="w-full">
        ...
        <textarea onChange={onDescChange} id={"desc-" + num} name={"desc " + num} rows="3" className="mt-1 p-2 w-full border rounded-md resize-none" value={val.description}></textarea>
      </form>
