...
const PositionCardDetail = ({ positionName, detail, onJoinClick }) => {
  return (
    <div className="flex items-center justify-between bg-gradient-to-r from-blue-500 to-cyan-300 p-4 rounded-xl shadow mb-4 w-[900px]  h-[90px] w-full">
      ...
      <button onClick={onJoinClick} className="w-[90px] bg-indigo-950 text-white text-sm px-4 py-2 rounded-lg hover:shadow-lg transition ease-in-out duration-150 hover:scale-105 active:scale-100">
        Join
      </button>
    </div>
  );
